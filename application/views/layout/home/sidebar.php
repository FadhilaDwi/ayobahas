    ...
    <nav class="px-nav px-nav-left">
        ...
        <ul class="px-nav-content">
            <li class="px-nav-box p-a-3 b-b-1" id="demo-px-nav-box">
                ...
                <img src="<?php echo base_url('assets/demo/avatars/1.jpg') ?>" alt="" class="pull-xs-left m-r-2 border-round" style="width: 54px; height: 54px;">
            ...
            <li class="px-nav-item px-nav-dropdown">
                ...
                <ul class="px-nav-dropdown-menu">
                    <li class="px-nav-item"><a href="<?php echo base_url('paket_tes') ?>"><span class="px-nav-label">Paket Tes</span></a></li>
